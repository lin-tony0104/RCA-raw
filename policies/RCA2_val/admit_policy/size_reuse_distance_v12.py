...
'''
from policies.RCA_val.admit_policy.admit_BASE import admit_BASE
from policies.RCA_val.lib.dequedict import DequeDict
...
#tw        
    ...
    def request(self, obj):
        ...
        #     self.region[r]=1/(self.avg_reuse_distance*obj.o_size)
